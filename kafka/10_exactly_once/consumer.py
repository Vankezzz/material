...
from config import bootstrap_servers, consumers_group_id_1, topic_1, cluster_bootstrap_servers
...
create_consumer(cluster_bootstrap_servers, consumers_group_id_1, topic_1)
